...
// ContainsPointEx returns true if the polygon contains a point.
// Returns the index of the hole that contains the point, or -1 if the point
// is not inside of a hole.
func (poly *Poly) ContainsPointEx(point Point) (contains bool, holeIndex int) {
	...
	return contains, holeIndex
}

func (poly *Poly) ContainsPoint(point Point) bool {
	contains, _ := poly.ContainsPointEx(point)
	return contains
}
